...
TIER_CONFIG: dict[PricingTier, dict[str, Any]] = {
    ...
    PricingTier.STARTER: {
        ...
        "description": "For small teams moving from one workflow into a limited cross-cloud operating scope.",
        "cta": "Start with Starter",
        "display_features": [
            "Includes all Free features",
            "Up to 5 AWS accounts plus limited Azure and GCP visibility",
            "AI insights + stronger budget alerting",
            "5 AI analyses/day",
            "BYOK supported (no platform surcharge)",
    ...
    PricingTier.GROWTH: {
        ...
        "description": "For growing teams that need cross-cloud controls, identity rollout readiness, and guided execution.",
        ...
        "display_features": [
            ...
            "Slack + Jira collaboration hooks with SSO rollout",
            "BYOK supported (no platform surcharge)",
    ...
    PricingTier.PRO: {
        ...
        "display_features": [
            ...
            "Compliance exports, savings proof, and audit evidence",
            "Cloud+ connectors + incident integrations",
