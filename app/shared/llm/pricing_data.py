...
LLM_PRICING: dict[str, dict[str, ProviderCost]] = {
    "groq": {
        "llama-3.3-70b-versatile": ProviderCost(
            input=0.59, output=0.79, free_tier_tokens=14000
        ),
        "mixtral-8x7b-32768": ProviderCost(
            input=0.27, output=0.27, free_tier_tokens=14000
        ),
...
async def refresh_llm_pricing(db_session: Any = None) -> None:
    ...
    try:
        ...
        for record in pricing_records:
            ...
            free_tier_tokens = _safe_int(
                getattr(record, "free_tier_tokens", 0), default=0
            )
