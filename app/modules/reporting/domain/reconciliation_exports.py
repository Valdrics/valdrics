...
def render_close_package_csv(
    ...
    writer.writerow(_sanitize_row(["meta", "tenant_id", tenant_id]))
    writer.writerow(_sanitize_row(["meta", "start_date", start_date.isoformat()]))
    writer.writerow(_sanitize_row(["meta", "end_date", end_date.isoformat()]))
