...
All code in this repository is licensed under Business Source License 1.1
(`BUSL-1.1`, commonly called `BSL 1.1`) unless stated otherwise.

## Boundary Policy

| Component Area | License | Boundary Decision |
| --- | --- | --- |
| Control plane APIs, schedulers, policy engine, reconciliation, billing workflows | BUSL-1.1 | Core proprietary control-plane logic. |
| Dashboard/UI and admin experiences | BUSL-1.1 | Product surface and workflow IP. |
| Production connector implementations in this repo | BUSL-1.1 | Operated as part of control-plane product. |
...
- Contributions to this repository are accepted under BUSL-1.1 / BSL 1.1.
