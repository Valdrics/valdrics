...
<article class="mx-auto max-w-4xl px-6 py-12 space-y-8">
	<header class="space-y-3">
		<h1 class="text-3xl font-semibold text-ink-100">Terms of Service</h1>
		<p class="text-sm text-ink-400">Last updated: March 1, 2026</p>
		<p class="text-sm text-ink-300">
			These terms govern access to and use of the Valdrics platform. By accessing or using the
			service, you agree to these terms on behalf of your organization.
		</p>
	</header>
	...
	<section class="space-y-3">
		<h2 class="text-xl font-semibold">2. Account and Security Responsibilities</h2>
	...
	<section class="space-y-3">
		...
		<p class="text-sm text-ink-300">
			Valdrics retains all rights, title, and interest in the service. Customers retain ownership of
			their data and configuration inputs.
		</p>
	</section>
