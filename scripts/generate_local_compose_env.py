...
The checked-in compose profile is intended for offline local development with
PostgreSQL and no shared-state cache dependency. This file must never be treated
as the supported managed production contract.
"""
...
def _render_env(template_lines: list[str], overrides: dict[str, str]) -> str:
    ...
    output_lines: list[str] = [
        ...
        "# Checked-in compose path is cacheless and is the only supported local compose topology in this repository.",
