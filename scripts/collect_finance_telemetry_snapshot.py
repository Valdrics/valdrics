...
from scripts.finance_telemetry_snapshot_queries import (
    fetch_llm_usage_snapshot,
...
async def collect_snapshot(
    *,
    ...
    async with async_session_maker() as db:
        ...
        subscription_snapshot = await fetch_subscription_snapshot(
            db,
            window_start=window_start,
            window_end_exclusive=window_end_exclusive,
            tracked_tiers=TRACKED_TIERS,
            active_subscription_statuses=ACTIVE_SUBSCRIPTION_STATUSES,
        )
        llm_snapshot = await fetch_llm_usage_snapshot(
            db,
            window_start=window_start,
            window_end_exclusive=window_end_exclusive,
            tracked_tiers=TRACKED_TIERS,
