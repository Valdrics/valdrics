...
- Branding and trademark terms.
- Support and SLA boundaries.
- Security and compliance responsibilities.
- Fees, term, renewal, and termination.
...
- Deployment model (single-tenant, multi-tenant, managed service, OEM).
- Expected customer count and regions.
